...
CREATE_OID_VARS(OID_PKI_DSTU7564_256, {1, 2, 804, 2, 1, 1, 1, 1, 2, 2, 1});
CREATE_OID_VARS(OID_HMAC_KUPYNA_256, {1, 2, 804, 2, 1, 1, 1, 1, 2, 2, 4});
CREATE_OID_VARS(OID_KALYNA256_CBC, {1, 2, 804, 2, 1, 1, 1, 1, 1, 3, 5, 2});
CREATE_OID_VARS(OID_PKI_DSTU4145_WITH_DSTU7564, {1, 2, 804, 2, 1, 1, 1, 1, 3, 6});
CREATE_OID_VARS(OID_PKI_DSTU4145_DSTU7564_PB_LE, {1, 2, 804, 2, 1, 1, 1, 1, 3, 6, 1, 1});
CREATE_OID_VARS(OID_PKI_DSTU4145_DSTU7564_PB_BE, {1, 2, 804, 2, 1, 1, 1, 1, 3, 6, 1, 1, 1});
...
/* RSA params. */
CREATE_OID_VARS(OID_RSA_ENCRYPTION, {1, 2, 840, 113549, 1, 1, 1});
CREATE_OID_VARS(OID_SHA1_WITH_RSA_ENCRYPTION, {1, 2, 840, 113549, 1, 1, 5});
CREATE_OID_VARS(OID_SHA256_WITH_RSA_ENCRYPTION, {1, 2, 840, 113549, 1, 1, 11});
CREATE_OID_VARS(OID_SHA384_WITH_RSA_ENCRYPTION, {1, 2, 840, 113549, 1, 1, 12});
CREATE_OID_VARS(OID_SHA512_WITH_RSA_ENCRYPTION, {1, 2, 840, 113549, 1, 1, 13});
...
const OidNumbers *oids_get_oid_numbers_by_id(OidId oid_id)
{
    switch (oid_id) {
        ...
        CASE_GET_OID_ST(OID_RSA_ENCRYPTION);
        CASE_GET_OID_ST(OID_SHA1_WITH_RSA_ENCRYPTION);
        CASE_GET_OID_ST(OID_SHA256_WITH_RSA_ENCRYPTION);
        CASE_GET_OID_ST(OID_SHA384_WITH_RSA_ENCRYPTION);
        CASE_GET_OID_ST(OID_SHA512_WITH_RSA_ENCRYPTION);
        ...
        CASE_GET_OID_ST(OID_PKI_DSTU7564_256);
        CASE_GET_OID_ST(OID_PKI_DSTU4145_WITH_DSTU7564);
        CASE_GET_OID_ST(OID_PKI_DSTU4145_DSTU7564_PB_LE);
        CASE_GET_OID_ST(OID_PKI_DSTU4145_DSTU7564_PB_BE);
        CASE_GET_OID_ST(OID_HMAC_KUPYNA_256);
        CASE_GET_OID_ST(OID_KALYNA256_CBC);
    }
