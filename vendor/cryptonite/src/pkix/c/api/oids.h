...
typedef enum OidId_st {
    ...
    OID_PKI_DSTU7564_256_ID                                 = 161,    /* 1.2.804.2.1.1.1.1.2.2.1 */
    OID_PKI_DSTU4145_WITH_DSTU7564_ID                       = 162,    /* 1.2.804.2.1.1.1.1.3.6 */
    OID_PKI_DSTU4145_DSTU7564_PB_LE_ID                      = 163,    /* 1.2.804.2.1.1.1.1.3.6.1.1 */
    OID_PKI_DSTU4145_DSTU7564_PB_BE_ID                      = 164,    /* 1.2.804.2.1.1.1.1.3.6.1.1.1 */
    OID_RSA_ENCRYPTION_ID                                   = 165,    /* 1.2.840.113549.1.1.1 */
    OID_SHA1_WITH_RSA_ENCRYPTION_ID                         = 166,    /* 1.2.840.113549.1.1.5 */
    OID_SHA256_WITH_RSA_ENCRYPTION_ID                       = 167,    /* 1.2.840.113549.1.1.11 */
    OID_SHA384_WITH_RSA_ENCRYPTION_ID                       = 168,    /* 1.2.840.113549.1.1.12 */
    OID_SHA512_WITH_RSA_ENCRYPTION_ID                       = 169,    /* 1.2.840.113549.1.1.13 */
    OID_HMAC_KUPYNA_256_ID                                 = 170,    /* 1.2.804.2.1.1.1.1.2.2.4 */
    OID_KALYNA256_CBC_ID                                   = 171,    /* 1.2.804.2.1.1.1.1.1.3.5.2 */
} OidId;
